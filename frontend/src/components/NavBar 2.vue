            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item" :class="{ 'active-nav-item': isActiveDashboard }">
                            <a class="nav-link" style="cursor:pointer;" @click="dashboardRefresh">Dashboard</a>
                        </li>
                        <li class="nav-item">
...
<script>
    ...
    export default{
        ...
        computed: {
            ...
            isProgressActive() {
                return this.$route.path === '/progress';
            },
            isAboutActive() {
